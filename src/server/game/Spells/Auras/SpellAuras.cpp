...
m_isRemoved(false), m_isSingleTarget(false), m_isUsingCharges(false), m_spellProto(0)
{
...
m_isRemoved(false), m_isSingleTarget(false), m_isUsingCharges(false), m_spellInfo(0)
{
