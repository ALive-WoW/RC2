...
class AuraEffect
{
    ...
    public:
        ...
        uint32 GetIdbyEntry() const { return m_spellProto->Id; }
        uint32 GetEffIndexbyEntry() const { return m_effIndex; }
        int32 GetBaseAmountbyEntry() const { return m_baseAmount; }
        int32 GetAmplitudebyEntry() const { return m_amplitude; }
    ...
    public:
		...
		bool Get_m_baseAmount()
		{
			return AuraEffect::m_baseAmount;
		}
