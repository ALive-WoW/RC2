...
class Spell
{
    ...
    public:
		...
		//Spell2(Unit* Caster, SpellEntry const *info, bool triggered, uint64 originalCasterGUID = 0, bool skipCheck = false, bool castedClientside = false);
        ~Spell();
		...
		//const SpellEntry * const m_spellInfo2;
        Item* m_CastItem;
		...
		bool IsTriggered2() const {return m_IsTriggeredSpell;};
		...
		//SpellEntry const* GetSpellInfo2() const { return m_spellInfo2; }
